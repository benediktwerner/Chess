...
public class Board {
    ...
    public void setBoardFromString(String[] board) {
        ...
        for (int x = 0; x < board.length; x++) {
            String line = board[board.length-x-1];
            for (int y = 0; y < board.length; y++) {
                ...
                switch (Character.toUpperCase(c)) {
                    ...
                    case 'N': pc = new Knight(new Point(x, y), p); break;
                    case 'R': pc = new Rook(new Point(x, y), p); break;
                    case 'B': pc = new Bishop(new Point(x, y), p); break;
                    case 'K': pc = new King(new Point(x, y), p); break;
    ...
    /**
     * Returns the piece at a point with offset
     */
